...
function InfoCards() {
    ...
    return (
        <Box sx={{ display: { md: 'flex' } }}>
            ...
            <Card sx={{ margin: 1, maxWidth: 280, boxShadow: 2 }} variant="outlined">
                <CardContent>
                    ...
                    <Typography variant="p" component="div">
                        Search of dog sitters based on location, availability, and rating.
                    </Typography>
                </CardContent>
            </Card>
            ...
            <Card sx={{ margin: 1, maxWidth: 280, boxShadow: 2 }} variant="outlined">
                <CardContent>
                    ...
                    <Typography variant="p" component="div">
                        User-friendly calendar for selecting wanted dog sitting days, possibility to request, confirm or decline bookings.
                    </Typography>
                </CardContent>
            </Card>
